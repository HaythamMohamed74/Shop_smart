...
class ProductModel with ChangeNotifier {
  ...
  factory ProductModel.fromFirestore(DocumentSnapshot doc) {
    var data = doc.data() as Map<String, dynamic>?; // Perform a null check
    if (data == null) {
      throw Exception("Data not found in Firestore document");
    }
    return ProductModel(
      ...
      productQuantity: data['Qty'], // Provide a default value of 0
    );
  }
  ...
  static List<ProductModel> localProds = [
    ...
    //     productImg: "https://i.ibb.co/BtMBSgK/1-iphone14-128gb-black.webp",
    //     productQuantity: 1),
    // ProductModel(
    //   //2
    ...
    //   productImg: "https://i.ibb.co/G7nXCW4/3-i-Phone-14.jpg",
    //   productQuantity: 1,
    // ),
    // ProductModel(
    //   //4
    ...
    //   productImg: "https://i.ibb.co/ww5WjkV/5-Samsung-Galaxy-S21-Ultra-5-G.png",
    //   productQuantity: 1,
    // ),
    // ProductModel(
    //   //     //12
    ...
    //   productImg: "https://i.ibb.co/kMR5mpR/12-ASUS-ROG-Zephyrus-G15.png",
    //   productQuantity: 1,
    // ),
    // ProductModel(
    //   //     //17
    ...
    //   productImg: "https://i.ibb.co/tsq0VD8/17-Samsung-Galaxy-Watch-4.png",
    //   productQuantity: 1,
    // ),
    // ProductModel(
    //     //22
